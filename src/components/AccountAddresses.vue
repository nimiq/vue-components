<template>
    <div class="wallet-identifier">
        <div v-for="n in 6" class="account" :key="n" :class="{ placeholder: n > addresses.length, 'pop-in': true }">
...
<style scoped>
    .wallet-identifier {
        position: relative;
        --hex-width: 9rem;
        --hex-height: calc(var(--hex-width) * (24 / 27)); /* from placeholder viewBox="0 0 58 49" */
